...
Webp 75%    
![75%](images/image-webp75%25.webp)

Скріншот  
Оригінал  
![Початок](images/screenshot.jpg)  
Webp 75%    
![75%](images/screenshot-webp75%25.webp)

Графіка з текстом 
Оригінал  
![Початок](images/text.jpg)  
Webp 75%    
![75%](images/text-webp75%25.webp)  

### Висновок

У ході виконання роботи було досліджено методи оптимізації зображень за допомогою сервісу Squoosh. Встановлено, що стиснення з втратою якості (lossy) дозволяє значно зменшити розмір файлів без помітного погіршення візуальної якості, особливо при використанні форматів WebP та AVIF.
